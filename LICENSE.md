...
copyright notice attached to or included in the Work (an example is
...
file named NOTICE is distributed along with the Work; if that
file is not already present in the Source distribution, you may
create and populate it with attribution notices from the Open
Source Licensors of modifications to the Work.
